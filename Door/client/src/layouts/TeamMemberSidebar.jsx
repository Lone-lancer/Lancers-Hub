...
// helpers
import { getTeamMemberMenuItems } from "../helpers/menu";
...
const UserBox = () => {
  ...
  return (
    <div className="user-box flex px-5 py-4 flex-col justify-center items-center text-center">
      ...
      <p className="text-gray-600 left-user-info">Team Member</p>
...
const SideBarContent = () => {
  return (
    <>
      ...
      <div id="sidebar-menu">
        <AppMenu menuItems={getTeamMemberMenuItems()} />
      </div>
...
const TeamMemberSidebar = ({ isCondensed }) => {
...
TeamMemberSidebar.defaultProps = {
  isCondensed: false,
};
