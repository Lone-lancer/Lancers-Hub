...
// helpers
import { getTeamLeaderMenuItems } from "../helpers/menu";
...
const UserBox = () => {
  ...
  return (
    <div className="user-box flex px-5 py-4 flex-col justify-center items-center text-center">
      ...
      <p className="text-gray-600 left-user-info">Team Leader</p>
...
const SideBarContent = () => {
  return (
    <>
      ...
      <div id="sidebar-menu">
        <AppMenu menuItems={getTeamLeaderMenuItems()} />
      </div>
...
const TeamLeaderSidebar = ({ isCondensed }) => {
...
TeamLeaderSidebar.defaultProps = {
  isCondensed: false,
};
