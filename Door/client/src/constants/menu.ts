...
const TEAM_LEADER_MENU_ITEMS: MenuItemTypes[] = [
  ...
  },
  {
    ...
    url: "/teamleader/report",
  },
];

const TEAM_MEMBER_MENU_ITEMS: MenuItemTypes[] = [
  { key: "navigation", label: "Navigation", isTitle: true },
  {
    key: "dashboard",
    label: "Dashboard",
  ...
  },
  {
    ...
    isTitle: false,
    icon: "mdi mdi-chart-line",
    url: "/teammember/report",
  },
];
const MANAGER_MENU_ITEMS: MenuItemTypes[] = [
  { key: "navigation", label: "Navigation", isTitle: true },
  {
    key: "dashboard",
    label: "Dashboard",
